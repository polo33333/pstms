...
const URL_TESTASSIGNMENT_LATEST = "$SERVER_NAME/ApiMobile/TestAssignment/GetTestAssignment_Latest/";
const URL_TATESTDATE_LATEST = "$SERVER_NAME/ApiMobile/TestAssignment/GetTATestDate_Latest/";
const URL_TESTASSIGNMENT_BYUID = "$SERVER_NAME/ApiMobile/TestAssignment/GetTestAssignment_ByUid/";
